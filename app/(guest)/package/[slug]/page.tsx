...
const PackageDetail = async ({ params }: { params: Promise<{ slug: string }> }) => {
    ...
    if (res?.data?.packages?.data[0]) {
        packageData = res.data.packages.data[0].attributes;
        ...
        packageId = res?.data?.packages?.data[0]?.id
    }
    ...
    return (
        <>
            <section className="container mx-auto mb-24">
                <div className="h-[530px] pt-16 pb-8 justify-center items-center gap-16 inline-flex">
                    <div className="w-full grid grid-cols-3 gap-4">
                        <div className="flex-col justify-start items-start gap-12 col-span-2">
                            ...
                            <div className="self-stretch mt-2 flex-col justify-start items-start gap-5 flex">
                                <div className="self-stretch  flex-col justify-start items-start gap-8 flex">
                                    <div className="self-stretch justify-start items-center gap-5 inline-flex">
                                        <div className="justify-start items-center gap-2 flex">
                                            <div><span className="text-[#475467] text-xl font-normal font-['Inter'] leading-[30px]">
                                                {heroImageSection?.qoute} </span><span
                                                    className="text-[#db6803] text-xl font-bold font-['Inter'] leading-[30px]">
                                                    <Link href={heroImageSection?.link?.href ?? ""}>
                                                        {heroImageSection?.link?.label}</Link>
                                                </span></div>
            ...
            {accreditedPartners &&
                <section>
                    <div
                        className="h-[945px] w-full py-12 bg-white flex-col justify-start items-center gap-[38px] inline-flex overflow-hidden">
                                                                        ...
                                                                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <g id="check-circle">
                                                                                <path id="Icon"
                                                                                    ...
                                                                                    stroke="#7F56D9" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
                                                                            </g>
                                                                        </svg>
                                                                    </div>
                                                                </div>
            ...
            <section className="container mx-auto">
                <div className="h-[913px] py-24 bg-white w-full flex-col justify-start items-center gap-16 inline-flex overflow-hidden">
