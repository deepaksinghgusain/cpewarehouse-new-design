                                                ...
                                                render={({ field, fieldState }) => (
                                                    <Field data-invalid={fieldState.invalid}>
                                                        ...
                                                        <Input
                                                            {...field}
                                                            id="firstName"
                                                            className='border-gray-200 focus:border-blue-500 focus:ring-blue-500 focus:border-2'
                                                    ...
                                                    <Field data-invalid={fieldState.invalid}>
                                                        ...
                                                        <div className="relative w-full">
                                                            <Input
                                                                ...
                                                                className='border-gray-200 pr-10 focus:border-blue-500 focus:ring-blue-500 focus:border-2'
                                                                aria-invalid={fieldState.invalid}
                                                            />
