  ...
  const updateTotal = () => {
    ...
    cartData.data.CartItem.map((ci: any, index: any) => {
      if (ci.course != undefined) {
        if (ci.courseId > 0) {
          total +=
            (ci.course.discount || ci.course.discountPrice) > 0
              ? ci.course.discount * ci.qty ||
                ci.course.discountPrice * ci.qty ||
                ci.course.discountPrice * ci.qty
          ...
          <div className="self-stretch  flex-col justify-start items-start gap-4 flex">
            <div className="justify-start items-center gap-3 inline-flex">
              <div className="justify-center items-center flex">
                <Link
                  href="/course-catalog"
                  className="text-[#475467] text-sm font-medium font-['Inter'] leading-tight"
                >
                  Course catalogue
                </Link>
              </div>
                    ...
                    <div className="w-full self-stretch flex-col justify-start items-start gap-5">
                      <div className="self-stretch flex-col justify-start items-start gap-4 flex">
                        <div className="h-6 flex-col justify-start items-start gap-[11px] flex">
                          <div className="justify-start items-center gap-3 inline-flex">
                            <div className="justify-center items-center flex">
                              <div className="w-5 h-5 p-[3px] bg-[#155dee] rounded-md  shadow-[0px_0px_0px_2px_rgba(255,255,255,1.00)] justify-center items-center flex overflow-hidden">
                                <div className="w-3.5 h-3.5 relative flex-col justify-start items-start flex overflow-hidden"></div>
